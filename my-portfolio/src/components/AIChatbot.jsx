...
const AIChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    { role: 'model', parts: [{ text: "Hi! I'm Animesh's AI agent. Ask me about his tech stack or projects!" }] }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'model', parts: [{ text: "Gemini is offline." }] }]);
    } finally {
      setLoading(false);
    }
  };
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              {loading && <div className="text-[#a855f7] text-xs font-mono animate-pulse">Thinking...</div>}
              <div ref={scrollRef} />
            </div>
            ...
            <div className="p-4 bg-[#0b0e14] border-t border-gray-800 flex gap-2">
              ...
              />
              <button onClick={handleSend} className="p-3 bg-linear-to-r from-[#717cf5] to-[#a855f7] rounded-xl text-white">
                <Send size={18} />
              </button>
            </div>
          </motion.div>
